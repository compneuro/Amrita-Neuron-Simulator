                        ...
                        <Grid>
                            <Row>
                                <Col md={4}>
                                    ...
                                    <RangeSliderComponent id={"stim1"}  name="s1_time1" value={param.s1_time1}  vertical={false} onChange={param.setStimuli}/>
                                </Col>
                                <Col md={2}>
                                    <SliderComponent  id={"stim1"}  name="s1_v1" value={param.s1_v1} height={150}   vertical={true} onChange={param.setStimuli}/>
                                </Col>
                                <Col md={4}>
                                    <div style={{height: 100}}/>

                                    <RangeSliderComponent id={"stim1"}  name="s1_time2" value={param.s1_time2} vertical={false} onChange={param.setStimuli}/>
                                </Col>
                                <Col md={2}>
                                    <SliderComponent id={"stim1"}  name="s1_v2" value={param.s1_v2} height={150}  vertical={true} onChange={param.setStimuli} />
                                </Col>
                            </Row>
                        </Grid>
